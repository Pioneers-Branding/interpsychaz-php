<?php
$pageTitle = '5 Ways to Manage Anxiety | Interventional Psychiatry of Arizona';
$bodyClass = 'wp-singular page-template-default page';
$pageDescription = '5 Ways to Manage Anxiety - Anxiety is a normal emotion that we all experience at one point or another. However, for some people, anxiety can be more constant and overwhelming,';
$pageOgImage = '/wp-content/uploads/2025/03/az-logo-white.png.png.webp';
$pageOgType = 'article';
$pageCanonical = 'https://interpsychaz.com/5-ways-to-manage-anxiety/';
...
<div class="container">
<h1 class="page-title">5 Ways to Manage Anxiety</h1>
</div>
</section>
...
<div class="g post post-176 type-post status-publish format-standard has-post-thumbnail hentry category-blog has_thumb" id="post-176">
...
</div><form action="/5-ways-to-manage-anxiety/" data-formid="2" enctype="multipart/form-data" id="gform_2" method="post" novalidate="">
...
<input class="gform_hidden" data-currency="USD" name="gform_currency" type="hidden" value="xiMFNMcu5NFFC9suvdhzZJxFYveihYT4Doy1uilQ3Dro6Pjpp8aMipcu/MrS1k7CWKtsKcPM5uJioc3ZFKH+GGPVZDDE8poEKqinDHp8mq/D4Ic="/>
<input class="gform_hidden" name="gform_unique_id" type="hidden" value=""/>
<input class="gform_hidden" name="state_2" type="hidden" value=""/>
