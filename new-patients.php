<?php
$pageTitle = 'New Patients | Interventional Psychiatry of Arizona';
$bodyClass = 'wp-singular page-template-default page page-id-485';
$pageDescription = 'New Patients -';
$pageOgImage = '/wp-content/uploads/2025/03/az-logo-white.png.png.webp';
$pageOgType = 'article';
$pageCanonical = 'https://interpsychaz.com/new-patients/';
$hideVisitUs = false;
...
<div id="content_box">
<div class="g post post-21 page type-page status-publish" id="post-21">
<div class="single_page">
<div class="post-content">
<div class="dm-service-section">
<div class="dm-container">
<div class="dm-flex">
<div class="dm-half wow fadeInRight"><img alt="new patients welcome Phoenix, AZ " data-lazy-src="/wp-content/uploads/2025/03/newpatients_img.jpg" decoding="async" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E"/><noscript><img alt="new patients welcome Phoenix, AZ " decoding="async" src="/wp-content/uploads/2025/03/newpatients_img.jpg"/></noscript></div>
<div class="dm-half wow fadeInLeft dm-space">
During your first visit with us, you will meet our kind and compassionate staff, and go over some basic health information. A comprehensive diagnostic exam will then be conducted, with attention to physical, genetic, developmental, emotional, cognitive, and social components.
<p>At Interventional Psychiatry of Arizona, we recognize that each patient has their own unique set of circumstances, so we utilize all of the diagnostic tools at our disposal in order to compile a complete and accurate assessment.</p>
<p>Once we complete the testing, we will review, explain, and discuss your results. Please feel free to ask any questions or bring up any concerns you may have. We pride ourselves on transparency and patient communication. Once we receive your results, we can work together to develop any treatment plans needed.</p>
</div>
</div>
</div>
</div>
...
</div><form action="/new-patients/" data-formid="2" enctype="multipart/form-data" id="gform_2" method="post" novalidate="">
...
<input class="gform_hidden" data-currency="USD" name="gform_currency" type="hidden" value="MQFBZtmoFTkqnHLfoBxZjUuHge4e8AWgVgdfRoKnmQO1sHtNC4TxQn1l84oKkDywLt5XCpvvbHBpdA8JNM4mxBvVTFKvey7N8NztB0GGng8Rx94="/>
<input class="gform_hidden" name="gform_unique_id" type="hidden" value=""/>
<input class="gform_hidden" name="state_2" type="hidden" value=""/>
