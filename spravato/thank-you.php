<?php
/**
 * Interventional Psychiatry of Arizona — SPRAVATO® eligibility confirmation page.
...
$HERO_BG    = $asset('ambience/hero-bg-inter.webp');
?>
<!DOCTYPE html>
...
<!-- Submit lead form SPRAVATO conversion on confirmation page load. -->
<script>
function gtag_report_conversion(url) {
  ...
  gtag('event', 'conversion', {
    'send_to': 'AW-11337249981/3A2_CLKNguwcEL3pgp4q',
    'value': 1.0,
    'currency': 'USD',
...
<title>Thank you | SPRAVATO&reg; at Interventional Psychiatry of Arizona</title>
<meta name="description" content="Your SPRAVATO® eligibility request has been received. A member of our team will reach out within one business day.">
...
<style>
  ...
  /* Same frosted panel as the eligibility form, so the confirmation feels like
...
<div class="pointer-events-none fixed inset-0 bg-brand-950/70"></div>
...
<main class="relative min-h-screen flex flex-col items-center justify-center px-6 py-14">
  ...
  <div class="glass rise mt-9 w-full max-w-xl rounded-[28px] p-8 sm:p-10 text-center" style="animation-delay:.08s">
    ...
    <p class="mt-5 text-[16.5px] leading-relaxed text-cream/70 font-light">
      A member of our team will review your answers, check your SPRAVATO&reg; benefits, and reach out
      within one business day to set up your evaluation.
    </p>
    ...
    <div class="mt-8 grid sm:grid-cols-3 gap-3 text-left">
      ...
      <div class="rounded-2xl border border-white/12 bg-white/[0.04] px-5 py-4">
        ...
        <p class="mt-1.5 text-[14px] leading-snug text-cream/80">Evaluation, and we file the prior authorization.</p>
      </div>
      <div class="rounded-2xl border border-white/12 bg-white/[0.04] px-5 py-4">
  ...
  <p class="rise mt-8 text-center text-[13px] text-cream/40" style="animation-delay:.16s">
    ...
    <span class="text-cream/25">&copy; <?= $YEAR ?> Interventional Psychiatry of Arizona ·
      SPRAVATO&reg; is a registered trademark of Janssen Pharmaceuticals, Inc.</span>
  </p>
</main>
