<?php
$pageTitle = 'Appointments | Interventional Psychiatry of Arizona';
$bodyClass = 'wp-singular page-template-default page page-id-380';
$pageDescription = 'Appointments -';
$pageOgImage = '/wp-content/uploads/2025/03/az-logo-white.png.png.webp';
$pageOgType = 'article';
$pageCanonical = 'https://interpsychaz.com/appointments/';
$hideVisitUs = false;
...
<div id="content_box">
<div class="g post post-31 page type-page status-publish" id="post-31">
