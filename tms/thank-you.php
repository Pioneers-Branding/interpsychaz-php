<?php
/**
 * Interventional Psychiatry of Arizona — TMS Therapy confirmation page.
...
$HERO_BG    = $asset('ambience/hero-tms.jpg');
?>
<!DOCTYPE html>
...
<script>
  gtag('event', 'conversion', {
      'send_to': 'AW-11337249981/zZ6ICPCI_OscEL3pgp4q',
      'value': 1.0,
      'currency': 'USD'
  });
</script>

<title>Thank you | TMS Therapy at Interventional Psychiatry of Arizona</title>
...
<main class="relative min-h-screen flex flex-col items-center justify-center px-6 py-14">
  ...
  <div class="glass rise mt-9 w-full max-w-xl rounded-[28px] p-8 sm:p-10 text-center" style="animation-delay:.08s">
    ...
    <p class="mt-5 text-[16.5px] leading-relaxed text-cream/70 font-light">
      A member of our team will check whether your plan covers TMS and reach out within one
      business day to book your evaluation.
    </p>
    ...
    <div class="mt-8 grid sm:grid-cols-3 gap-3 text-left">
      <div class="rounded-2xl border border-white/12 bg-white/[0.04] px-5 py-4">
        ...
        <p class="mt-1.5 text-[14px] leading-snug text-cream/80">We check your TMS benefits and file any prior authorization.</p>
      </div>
      <div class="rounded-2xl border border-white/12 bg-white/[0.04] px-5 py-4">
        <p class="text-[11.5px] uppercase tracking-[0.16em] text-cream/40">Then</p>
        <p class="mt-1.5 text-[14px] leading-snug text-cream/80">An evaluation confirms TMS is right for you, and maps your treatment.</p>
      </div>
      <div class="rounded-2xl border border-white/12 bg-white/[0.04] px-5 py-4">
