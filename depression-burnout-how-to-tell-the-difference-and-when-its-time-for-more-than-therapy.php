...
<div class="g post post-745 type-post status-publish format-standard has-post-thumbnail hentry category-blog has_thumb" id="post-745">
...
<li>Reduced performance or motivation</li>
...
<li>Loss of interest or pleasure in activities (anhedonia)</li>
...
<ul class="wp-block-list">
<li>No anesthesia or downtime</li>
<li>Minimal side effects</li>
<li>FDA-approved for depression</li>
</ul>
<hr class="wp-block-separator has-alpha-channel-opacity"/>
<h3 class="wp-block-heading"><strong>2. Ketamine Therapy</strong></h3>
<p class="wp-block-paragraph">Ketamine works rapidly to improve mood by targeting different brain pathways than traditional antidepressants.</p>
<p class="wp-block-paragraph"><strong>Benefits:</strong></p>
<ul class="wp-block-list">
<li>Fast-acting relief (often within hours to days)</li>
<li>Effective for treatment-resistant depression</li>
<li>Can reduce suicidal thoughts</li>
</ul>
<hr class="wp-block-separator has-alpha-channel-opacity"/>
<h3 class="wp-block-heading"><strong>3. Medication Management (Personalized)</strong></h3>
...
<li>Help when other treatments have failed</li>
...
<hr class="wp-block-separator has-alpha-channel-opacity"/>
<h3 class="wp-block-heading"><strong>Q: How quickly do these treatments work?</strong></h3>
<p class="wp-block-paragraph"><strong>A:</strong> TMS typically shows improvement over several weeks, while ketamine therapy can provide relief within days.</p>
<hr class="wp-block-separator has-alpha-channel-opacity"/>
<h3 class="wp-block-heading"><strong>Q: Do I have to stop my current medications?</strong></h3>
<p class="wp-block-paragraph"><strong>A:</strong> Not necessarily. We evaluate your current treatment plan and make recommendations based on your specific needs.</p>
<hr class="wp-block-separator has-alpha-channel-opacity"/>
...
<hr class="wp-block-separator has-alpha-channel-opacity"/>
<h3 class="wp-block-heading"><strong>Q: Will my insurance cover treatment?</strong></h3>
...
</div><form action="/depression-burnout-how-to-tell-the-difference-and-when-its-time-for-more-than-therapy/" data-formid="2" enctype="multipart/form-data" id="gform_2" method="post" novalidate="">
...
<input class="gform_hidden" data-currency="USD" name="gform_currency" type="hidden" value="PQV/hDqs7fpNZ5zefDItVQKv98WhGaqkrBty0FxzTW2Q34ILQFt8NUVlToYtATtklZ5xN9ej64EyOOulZtuYnBs0DACyKHWUps9z0cmCQ8rqFg0="/>
<input class="gform_hidden" name="gform_unique_id" type="hidden" value=""/>
<input class="gform_hidden" name="state_2" type="hidden" value=""/>
