<?php
$pageTitle = 'Privacy Policy | Interventional Psychiatry of Arizona';
$bodyClass = 'wp-singular page-template-default page page-id-518';
$pageDescription = 'Privacy Policy - Who we are Our website address is: . Comments When visitors leave comments on the site we collect the data shown in the comments form, and also the';
$pageOgImage = '/wp-content/uploads/2025/03/az-logo-white.png.png.webp';
$pageOgType = 'article';
$pageCanonical = 'https://interpsychaz.com/privacy-policy/';
$hideVisitUs = false;
...
<div id="content_box">
<div class="g post post-47 page type-page status-publish" id="post-47">
...
<p>Replace this paragraph with the list of services this site actually uses. The Discovered screen in the site administration lists every off-domain host the site has been seen reaching, which is the accurate starting point. Name each company, say what it is for, and link its own privacy policy.</p>
<h3>Your choices</h3>
<p>Every browser can block or delete cookies, usually under Privacy or Site settings. Blocking them wholesale will stop parts of this site working. You can also reopen this site's own notice at any time:</p>
<button class="dmm-cg-open dmm-cg-open--inline" type="button">Review your choices</button>
<p><em>Cookie disclosure last reviewed: August 14, 2026. Update this date whenever the list of companies above changes.</em></p>
</div>
<p><!-- dmm-cg:cookies:end --></p>
...
<p><strong>*Consumer information is not shared with third-parties for marketing purposes</strong></p>
