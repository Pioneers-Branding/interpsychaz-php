<?php
$pageTitle = 'Accessibility | Interventional Psychiatry of Arizona';
$bodyClass = 'wp-singular page-template-default page page-id-524';
$pageDescription = 'Accessibility -';
$pageOgImage = '/wp-content/uploads/2025/03/az-logo-white.png.png.webp';
$pageOgType = 'article';
$pageCanonical = 'https://interpsychaz.com/accessibility/';
$hideVisitUs = false;
...
<div id="content_box">
<div class="g post post-10 page type-page status-publish" id="post-10">
...
<p>Email:<br/>
<a href="mailto:admin@interpsychaz.com">admin@interpsychaz.com</a></p>
<p>If you feel that these standards have not been maintained in your situation, please let us know by calling: <a class="inline-dm-phone" href="tel:(602) 824-8404">(602) 824-8404</a> we gladly accept TRS calls.</p>
</div>
</div>
</div>
</div>
