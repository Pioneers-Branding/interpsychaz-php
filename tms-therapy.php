					...
					<div class="post-content">
								...
								<div class="dm-flex">
									<div class="dm-half wow fadeInRight">
										...
										<div class="rll-youtube-player"
											data-alt="Magstim - An overview of TMS (Transcranial Magnetic Stimulation)"
											data-id="d649edvxsyE" data-query=""
											data-src="https://www.youtube.com/embed/d649edvxsyE"></div><noscript><iframe
												allowfullscreen="allowfullscreen" frameborder="0" height="387"
												src="https://www.youtube.com/embed/d649edvxsyE"
												title="Magstim - An overview of TMS (Transcranial Magnetic Stimulation)"
						...
						<div class="dm-service-section">
							<div class="dm-container">
								<div class="dm-flex">
									<div class="dm-half wow fadeInRight">
										<div class="wp-video" style=""><video class="wp-video-shortcode"
												controls="controls" height="700" id="video-98-1" preload="metadata">
												<source
													src="/wp-content/uploads/2025/07/Interpsychaz.Com-1Compressed.mp4"
													type="video/mp4" /><a
													href="/wp-content/uploads/2025/07/Interpsychaz.Com-1Compressed.mp4">/wp-content/uploads/2025/07/Interpsychaz.Com-1Compressed.mp4</a>
											</video></div>
									</div>
									<div class="dm-half wow fadeInLeft dm-space">
										<p>TMS Therapy is:</p>
						...
						<div class="dm-service-section">
							<div class="dm-container">
								<div class="dm-flex">
									<div class="dm-third">
										<div class="rll-youtube-player" data-alt="Magstim TMS Stories - Tish's Story"
											data-id="937QadE0j1U" data-query=""
											data-src="https://www.youtube.com/embed/937QadE0j1U"></div><noscript><iframe
												allowfullscreen="allowfullscreen" frameborder="0" height="218"
												src="https://www.youtube.com/embed/937QadE0j1U"
												title="Magstim TMS Stories - Tish's Story"
												width="387"></iframe></noscript>
									</div>
									<div class="dm-third">
										<div class="rll-youtube-player" data-alt="Magstim TMS Stories - Rod's story"
											data-id="gW3kPC36fSU" data-query=""
											data-src="https://www.youtube.com/embed/gW3kPC36fSU"></div><noscript><iframe
												allowfullscreen="allowfullscreen" frameborder="0" height="218"
												src="https://www.youtube.com/embed/gW3kPC36fSU"
												title="Magstim TMS Stories - Rod's story"
												width="387"></iframe></noscript>
									</div>
									<div class="dm-third">
										<div class="rll-youtube-player" data-alt="Magstim TMS stories - Desiree's story"
											data-id="HEzuX2J0kz4" data-query=""
											data-src="https://www.youtube.com/embed/HEzuX2J0kz4"></div><noscript><iframe
												allowfullscreen="allowfullscreen" frameborder="0" height="218"
												src="https://www.youtube.com/embed/HEzuX2J0kz4"
												title="Magstim TMS stories - Desiree's story"
												width="387"></iframe></noscript>
									</div>
								</div>
							</div>
		...
		<div class="dm-flex">
			...
			<div class="dm-half">
				...
				<div class="gf_browser_chrome gform_wrapper gravity-theme gform-theme--no-framework" data-form-index="0"
					...
					<form action="/services/tms-therapy/" data-formid="2" enctype="multipart/form-data" id="gform_2"
							...
							<div class="gform_fields top_label form_sublabel_below description_below validation_below"
								...
								<div class="gfield gfield--type-honeypot gform_validation_container field_sublabel_below gfield--has-description field_description_below field_validation_below gfield_visibility_visible"
									id="field_2_9"><label class="gfield_label gform-field-label" for="input_2_9"><span
											class="gform-field-label__text">X/Twitter</span></label>
						...
						<div class="gform-footer gform_footer top_label"> <button class="gform_button button"
							...
							<input class="gform_hidden" data-currency="USD" name="gform_currency" type="hidden"
								value="iNiLH2UbzNi7YYxVOzgd0kjcngzmEoPU4M3gCb+vYtehym/Bo/r9gvbykjzgOxGwIBgWFyxtKVyZhbNwCO3s9hQkXhIDz/mIWUcd+PzspgNeGrc=" />
							<input class="gform_hidden" name="gform_unique_id" type="hidden" value="" />
							<input class="gform_hidden" name="state_2" type="hidden"
								value="" />
